(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ngrx/store'), require('@angular/core'), require('@angular/forms'), require('rxjs/BehaviorSubject'), require('@angular/common/http'), require('rxjs/Rx'), require('@angular/router'), require('tslib'), require('rxjs/add/operator/map'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/switchMap'), require('rxjs/Observable'), require('@ngrx/effects'), require('rxjs/operators'), require('@angular/common'), require('@angular/flex-layout'), require('@angular/platform-browser/animations'), require('@angular/material')) :
    typeof define === 'function' && define.amd ? define('@soushians/config', ['exports', '@ngrx/store', '@angular/core', '@angular/forms', 'rxjs/BehaviorSubject', '@angular/common/http', 'rxjs/Rx', '@angular/router', 'tslib', 'rxjs/add/operator/map', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/switchMap', 'rxjs/Observable', '@ngrx/effects', 'rxjs/operators', '@angular/common', '@angular/flex-layout', '@angular/platform-browser/animations', '@angular/material'], factory) :
    (factory((global.soushians = global.soushians || {}, global.soushians.config = {}),null,global.ng.core,global.ng.forms,global.Rx,global.ng.common.http,global.Rx,global.ng.router,global.tslib,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx,null,global.Rx.Observable.prototype,global.ng.common,global.ng['flex-layout'],global.ng.platformBrowser.animations,global.ng.material));
}(this, (function (exports,store,core,forms,BehaviorSubject,http,Rx,router,tslib,map,mergeMap,switchMap,Observable,effects,operators,common,flexLayout,animations,material) { 'use strict';
    ...
    var ConfigsComponent = (function () {
         ...
         * @param {?} store
         */
        function ConfigsComponent(configService, store$$1) {
            this.configService = configService;
            this.store = store$$1;
    ...
    /** @nocollapse */
    ConfigModuleContainerComponent.ctorParameters = function () {
        return [
            { type: ConfigService, },
        ];
    };
    ...
    var LoadConfigEffects = (function () {
         ...
         * @param {?} configService
         */
        function LoadConfigEffects(actions$, router$$1, configService) {
            var _this = this;
