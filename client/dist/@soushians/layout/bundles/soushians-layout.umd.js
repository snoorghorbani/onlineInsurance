(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ngrx/store'), require('@angular/core'), require('@soushians/config'), require('rxjs/BehaviorSubject'), require('@angular/animations'), require('@soushians/authentication'), require('@angular/common'), require('@angular/platform-browser'), require('rxjs/observable/fromEvent'), require('@angular/router'), require('rxjs'), require('@angular/forms'), require('@angular/common/http'), require('@angular/flex-layout'), require('@ngrx/effects'), require('@angular/material')) :
    typeof define === 'function' && define.amd ? define('@soushians/layout', ['exports', '@ngrx/store', '@angular/core', '@soushians/config', 'rxjs/BehaviorSubject', '@angular/animations', '@soushians/authentication', '@angular/common', '@angular/platform-browser', 'rxjs/observable/fromEvent', '@angular/router', 'rxjs', '@angular/forms', '@angular/common/http', '@angular/flex-layout', '@ngrx/effects', '@angular/material'], factory) :
    (factory((global.soushians = global.soushians || {}, global.soushians.layout = {}),null,global.ng.core,null,global.Rx,global.ng.animations,null,global.ng.common,global.ng.platformBrowser,global.Rx.Observable,global.ng.router,null,global.ng.forms,global.ng.common.http,global.ng['flex-layout'],null,global.ng.material));
}(this, (function (exports,store,core,config,BehaviorSubject,animations,authentication,common,platformBrowser,fromEvent,router,rxjs,forms,http,flexLayout,effects,material) { 'use strict';
    ...
    var NgsLayoutModule = (function () {
        ...
        NgsLayoutModule.forRoot = function (config$$1) {
            return {
                ...
                providers: [{ provide: MODULE_CONFIG_TOKEN, useValue: config$$1 }, LayoutConfigurationService]
            };
        };
    ...
    exports.LayoutReducers = LayoutReducers;
    exports.selectLayoutState = selectLayoutState;
    exports.getLayout = getLayout;
    exports.getTitle = getTitle$1;
    exports.getShowMainSidenav = getShowMainSidenav$1;
    exports.getMainSideNavMode = getMainSideNavMode$1;
    exports.getLayoutMode = getLayoutMode$1;
    exports.getShowSecondSidebarStatus = getShowSecondSidebarStatus$1;
    exports.getSecondSidebarMode = getSecondSidebarMode$1;
    exports.getLayoutToolbar = getLayoutToolbar;
    exports.getLayoutToolbarMode = getLayoutToolbarMode;
