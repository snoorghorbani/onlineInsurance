...
class PersianDatePipe {
    ...
    transform(value, exponent) {
        if (!value)
            return '';
        let /** @type {?} */ date = new Date(/** @type {?} */ (value));
...
export { PERSIAN_MONTH_DAYS_COUNT, PERSIAN_MONTH_NAMES, DateClass, UtilityService, stringTemplate, MatchValidator, DataUnitPipe, TimeUnitPipe, PersianDatePipe, CurrencyUnitPipe, PersianNumberPipe, TimeCounterPipe, DataUnitService, InfraModule, CurrencyUnitPipe as ɵc, DataUnitPipe as ɵa, DataUnitService as ɵg, PersianDatePipe as ɵd, PersianNumberPipe as ɵe, TimeCounterPipe as ɵf, TimeUnitPipe as ɵb };
