...
export class PolicyService {
	...
	GetCarModelsOfBrand(data: GetCarModelsOfBrandApiModel.Request): Observable<PolicyModel[]> {
		...
		return (
			this.http
				// .get(`${URI}GetCarModelsOfBrand`, { params: model.getRequestQueryParams() })
				.get(`${URI}GetCarModelsOfBrand`, { params: model.getRequestQueryParams() })
				.map((response: any) => response.Result as PolicyModel[])
		);
	}
	ComparePolicies(data: ComparePoliciesApiModel.Request): Observable<PolicyModel[]> {
		const model = new ComparePoliciesApiModel.Request(data);
		return (
			this.http
				// .post(`${URI}ComparePolicies`, model.getRequestBody())
				.post("http://localhost:3000/api/fake/ComparePolicies", model.getRequestBody())
				.map((response: any) => response.Result as PolicyModel[])
		);
	}
}
...
var zz = {
	...
	CarBrand: {
		...
		Options: [
			...
			{
				ExtensionData: {},
				DisplayValue: "بی ام و",
				Value: 12
			},
			{
				ExtensionData: {},
				DisplayValue: "برلیانس",
				Value: 13
			},
			{
				ExtensionData: {},
			...
			{
				ExtensionData: {},
				DisplayValue: "سانگ یانگ",
				Value: 34
			},
			{
				ExtensionData: {},
				DisplayValue: "سیتروئن",
				Value: 35
			},
			{
				ExtensionData: {},
			...
			{
				ExtensionData: {},
				DisplayValue: "گریت وال",
				Value: 44
			},
			{
				ExtensionData: {},
				DisplayValue: "گک گونو",
				Value: 45
			},
			{
				ExtensionData: {},
			...
			{
				ExtensionData: {},
				DisplayValue: "مازراتی",
				Value: 52
			},
			{
				ExtensionData: {},
				DisplayValue: "میتسوبیشی",
				Value: 53
			},
			{
				ExtensionData: {},
	...
	CarYearsWithoutIncident: {
		...
		Options: [
			...
			{
				ExtensionData: {},
				DisplayValue: "14.5 سال",
				Value: 14.5
			},
			{
				ExtensionData: {},
				DisplayValue: "بیش از 14 سال",
				Value: 15
			}
		],
		SequenceIndex: 96,
	...
	PolicyAddressSource: {
		...
		Options: [
			{
				ExtensionData: {},
				DisplayValue: "نشانی ارسال",
				Value: 1
			},
			{
				ExtensionData: {},
				DisplayValue: "مطابق بیمه نامه قبلی",
				Value: 2
			},
			{
				ExtensionData: {},
	...
	PolicyPushesheMali: {
		...
		Options: [
			...
			{
				ExtensionData: {},
				DisplayValue: "۱۰,۰۰۰,۰۰۰ تومان",
				Value: 10000000
			},
			{
				ExtensionData: {},
				DisplayValue: "۱۵,۰۰۰,۰۰۰ تومان",
				Value: 15000000
			},
			{
				ExtensionData: {},
				DisplayValue: "۲۰,۰۰۰,۰۰۰ تومان",
				Value: 20000000
			},
			{
				ExtensionData: {},
				DisplayValue: "۳۰,۰۰۰,۰۰۰ تومان",
				Value: 30000000
			}
		],
		SequenceIndex: 126,
