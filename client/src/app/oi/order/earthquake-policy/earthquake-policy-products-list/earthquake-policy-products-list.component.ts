...
@Component({
	selector: "order-earthquake-policy-products-list",
	templateUrl: "./earthquake-policy-products-list.component.html",
	styleUrls: [ "./earthquake-policy-products-list.component.css" ]
})
export class EarthquakePolicyProductsListComponent implements OnInit, OnDestroy {
