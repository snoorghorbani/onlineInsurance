...
import {MatExpansionModule,MatRadioModule, MatIconModule, MatButtonModule, MatCardModule, MatProgressBarModule, MatDatepickerModule, MatToolbarModule, MatInputModule, MatMenuModule, MatListModule, MatFormFieldModule, MatSelectModule, MatSnackBarModule, MatSidenavModule } from "@angular/material";
...
import { BankListContainerComponent, SuccessPaymentReportContainerComponent, PaymentModuleContainerComponent } from "./smart-components";
    ...
    static forRoot(config: PaymentModuleConfig): ModuleWithProviders {
        return {
            ...
            providers: [
                ...
                PaymentConfigurationService, BankService, CachingInterceptor, PaymentService,
            ]
        }
    }
}
