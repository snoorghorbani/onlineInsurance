...
export class PackageService {
	...
	getUserPackage(data: UserPackagesModel.Request): Observable<UserPackagesModel.Response> {
		...
		let { Username } = model;
		return this.http
			.get(`http://wifi.shatel.ir/api/v1/packages/user/${Username}`, {
	...
	getPackageList(data: PackageListModel.Request): Observable<PackageListModel.Response> {
		return this.http
			.get(`http://wifi.shatel.ir/api/v1/packages/details`, {
				withCredentials: true
			})
			.map(response => {
				return { data: response.json() };
	...
	PackageAdd(data: PackageAddModel.Request): Observable<PackageAddModel.Response> {
		...
		return this.http
			.post(`http://wifi.shatel.ir/api/v1/packages`, model.getRequestBody(), { withCredentials: true })
	...
	PackageEdit(data: PackageEditModel.Request): Observable<PackageEditModel.Response> {
		...
		let { Id } = model;
		return this.http
			.get(`http://wifi.shatel.ir/api/v1/packages/${Id}`, {
				withCredentials: true
			})
			.map(response => response.json());
	}
	FetchPackage(id: string): Observable<FetchPackageModel.Response> {
		debugger;
		return this.http
			.get(`http://wifi.shatel.ir/api/v1/packages/${id}/details`, {
				withCredentials: true
			})
			.map(response => response.json());
	}
...
var compareResult = [
	...
	{
		prices: [ { id: "1396-13-385-560-952-88", title: "یک ساله", price: 1005786, cover: 7000000 } ],
		companyName: "معلم",
		id: 13,
		totalPenalty: 33150,
		dayPenalty: 13,
		...
		branch: 50,
		discount: 0.0,
		installment: [ { percent: 1, date: 0 } ]
	},
	{
		prices: [
			{ id: "1396-9-415-601-1036-100", title: "سه ماهه", price: 402314, cover: 7000000 },
			{ id: "1396-9-415-601-1036-101", title: "چهار ماهه", price: 502893, cover: 7000000 },
			{ id: "1396-9-415-601-1036-102", title: "شش ماهه", price: 804629, cover: 7000000 },
			{ id: "1396-9-415-601-1036-103", title: "نه ماهه", price: 804629, cover: 7000000 },
			{ id: "1396-9-415-601-1036-1052", title: "یک ساله", price: 1005786, cover: 7000000 }
		],
		companyName: "كوثر",
		id: 9,
		totalPenalty: 33150,
	...
	{
		prices: [
			{ id: "1396-1-289-406-724-70", title: "سه ماهه", price: 301735, cover: 7000000 },
			{ id: "1396-1-289-406-724-71", title: "شش ماهه", price: 603471, cover: 7000000 },
			{ id: "1396-1-289-406-724-72", title: "یک ساله", price: 1005786, cover: 7000000 }
		],
		companyName: "البرز",
		id: 1,
		totalPenalty: 33150,
		...
		branch: 40,
		discount: 0.0,
		installment: [ { percent: 0.4, date: 0 }, { percent: 0.3, date: 2 }, { percent: 0.3, date: 5 } ]
	},
	{
		prices: [
			{ id: "1396-14-243-326-572-55", title: "سه ماهه", price: 282789, cover: 7000000 },
			{ id: "1396-14-243-326-572-56", title: "شش ماهه", price: 565768, cover: 7000000 },
			{ id: "1396-14-243-326-572-57", title: "یک ساله", price: 942946, cover: 7000000 }
		],
	...
	{
		prices: [ { id: "1396-3-317-503-800-74", title: "یک ساله", price: 1005786, cover: 7000000 } ],
		companyName: "آسیا",
		id: 3,
		totalPenalty: 33150,
		dayPenalty: 13,
	...
	{
		prices: [ { id: "1396-10-375-541-938-87", title: "یک ساله", price: 1005786, cover: 7000000 } ],
		companyName: "ما",
		id: 10,
		totalPenalty: 33150,
		dayPenalty: 13,
	...
	{
		prices: [
			{ id: "1396-5-361-483-900-84", title: "یک ساله", price: 1005786, cover: 7000000 },
			{ id: "1396-5-361-483-900-97", title: "شش ماهه", price: 603471, cover: 7000000 }
		],
		companyName: "دانا",
		id: 5,
		totalPenalty: 33150,
